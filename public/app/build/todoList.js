...
function _createData() {
  _createData = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var url,
        data,
        _args = arguments;
...
function verifyData() {
  return _verifyData.apply(this, arguments);
}

function _verifyData() {
  _verifyData = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
    var url,
        data,
        _args2 = arguments;
...
function _deleteData() {
  _deleteData = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee3() {
    var url,
        data,
        _args3 = arguments;
...
function _updateData() {
  _updateData = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee4() {
    var url,
        id,
        data,
        _args4 = arguments;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            id = _args4.length > 1 ? _args4[1] : undefined;
...
function showData(_x, _x2) {
  return _showData.apply(this, arguments);
}

function _showData() {
  _showData = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee5(url, id) {
...
function getResult(_x3, _x4) {
  return _getResult.apply(this, arguments);
}

function _getResult() {
  _getResult = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee6(url, params) {
...
function _getRegion() {
  _getRegion = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee7() {
    var url,
        data,
        _args7 = arguments;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee7$(_context7) {
      while (1) {
        switch (_context7.prev = _context7.next) {
          case 0:
            url = _args7.length > 0 && _args7[0] !== undefined ? _args7[0] : '';
...
function _getRoute() {
  _getRoute = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee8() {
    var url,
        data,
        _args8 = arguments;
...
var DataUser = function () {
  var initTable1 = function initTable1() {
    var table = $('#kt_datatable_todolist'); // begin first table
      ...
      columnDefs: [{
        ...
        render: function render(data, type, row, meta) {
          if (row.completed == true) {
            ...
            return "\n                            <a data=" + row.id + " href=\"#\" onclick=\"verifyList(this)\"  class=\"btn btn-sm btn btn-success btn-clean btn-icon btn-icon-md\" title=\"Completed Todo List\">\n                                <i class=\"fa fa-check\"></i>\n                            </a>";
          }
        }
      }, {
        targets: -1,
...
window.removeOrders = function (input, evt) {
  $(input).parent().parent().remove();
  evt.preventDefault();
};

window.openModalEdit = function (input, evt) {
  evt.preventDefault();
  var data = {
    id: $(input).attr('data')
  };
  (0,_api__WEBPACK_IMPORTED_MODULE_0__.getResult)('/todoList/' + $(input).attr('data')).then(function (res) {
    var response = res.data;

    if (response.success) {
      $('#editTodoList').modal('show'); // console.log(response.data.title);
...
window.submitOrders = function (input, evt) {
  evt.preventDefault();
  var titles = $(".title");
  var title = [];
  var description = [];
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      (0,_api__WEBPACK_IMPORTED_MODULE_0__.createData)("/createTodoList", data).then(function (res) {
        var response = res.data;
...
window.updateForm = function (input, evt) {
  evt.preventDefault();
  var data = {
    id: getValue('e_id'),
  ...
  Swal.fire({
    ...
    if (result.isConfirmed) {
      (0,_api__WEBPACK_IMPORTED_MODULE_0__.createData)('/updateTodoList', data).then(function (res) {
        var response = res.data;
...
window.deleteList = function (input) {
  var data = {
    id: $(input).attr('data')
  };
  Swal.fire({
    ...
    if (result.value) {
      (0,_api__WEBPACK_IMPORTED_MODULE_0__.deleteData)('/todoList/' + $(input).attr('data')).then(function (res) {
        var response = res.data;
...
window.verifyList = function (input) {
  var data = {
    id: $(input).attr("data")
  };
  Swal.fire({
    ...
    (0,_api__WEBPACK_IMPORTED_MODULE_0__.verifyData)("/verifyTodoList/" + $(input).attr("data")).then(function (res) {
      var response = res.data;
